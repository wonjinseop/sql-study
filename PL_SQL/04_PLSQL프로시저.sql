...
IS -- 선언부
    v_msg VARCHAR2(30) := 'Hllo Procedure!';
BEGIN -- 시작부
...
BEGIN
    ...
    -- 이미 존재 한다면 1, 존재하지 않는다면 0 -> v_cnt에 저장
    SELECT
        COUNT(*)
    INTO
        v_cnt
...
BEGIN
    ...
    dbms_output.put_line('p_var2: ' || p_var2); -- OUT: 값을 전달했음에도 불구하고 프로시제 내에서 확인 불가.
