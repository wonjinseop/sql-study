...
-- 테이블 레벨 제약 조건 (모든 열을 선언 후 제약 조건을 취하는 방식)
CREATE TABLE dept2 (
    dept_no NUMBER(2),
...
-- 외래 키(foraign key)가 부모테이블(참조테이블)에 없다면 INSERT 불가능.
INSERT INTO dept2
...
-- fk 추가
ALTER TABLE dept2 ADD CONSTRAINT dept2_loka_locid_fk
